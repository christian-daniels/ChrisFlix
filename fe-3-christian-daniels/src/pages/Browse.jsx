...
const Browse = ({
  ...
  const handleSearch = (e) => {
    ...
    Movies.browse(loggedinUser, sessionId, phrase, orderby, direction, limit)
      .then((response) => {
  ...
  return (
    <div>
      ...
      <div className="form-box-browse" >
      <h1>Browse</h1>
        <form onSubmit={handleSearch}>
          <label className="form-label">Browse movies by Phrase</label>
          <input
